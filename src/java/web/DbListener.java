    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        try {
            ...
            if(CategoryEnum.getList().isEmpty()){
                ...
                stmt.executeUpdate("INSERT INTO category_enum VALUES (NULL, 'Curiosidades')");
            }
            ...
            if(Question.getList().isEmpty()){
                ...
                stmt.executeUpdate("INSERT INTO questions VALUES ('Normalmente, quantos litros de sangue uma pessoa tem?', 'Entre 4 a 6 litros.', 'Tem entre 2 a 4 litros.', 'Tem 7 litros', 3)");
                stmt.executeUpdate("INSERT INTO questions VALUES ('Em média, quantos litros são retirados numa doação de sangue?', 'São retirados 450 mililitros', 'São retirados 0,5 litro', 'São retirados 1,5 litros', 3)");
                stmt.executeUpdate("INSERT INTO questions VALUES ('De onde é a invenção do chuveiro elétrico?', 'Brasil', 'Inglaterra', 'França', 3)");
                stmt.executeUpdate("INSERT INTO questions VALUES ('Qual o nome do presidente do Brasil que ficou conhecido como Jango?', 'João Goulart', 'Jânio Quadros', 'Getúlio Vargas', 3)");
                ...
                stmt.executeUpdate("INSERT INTO questions VALUES ('Quantos vezes o palmeiras já caiu para a serie B?', '2', '0', '1', 1)");
                ...
                stmt.executeUpdate("INSERT INTO questions VALUES ('Quantos graus são necessários para que dois ângulos sejam complementares?', '90', '45', '180', 2)");
                ...
                stmt.executeUpdate("INSERT INTO questions VALUES ('Qual é o elemento mais abundante na superfície da Terra?', 'Oxigênio', 'Hidrogênio', 'Hélio', 2)");
                stmt.executeUpdate("INSERT INTO questions VALUES ('Qual é o elemento mais abundante do universo?', 'Hidrogênio', 'Oxigênio', 'Hélio', 2)");
                ...
                stmt.executeUpdate("INSERT INTO questions VALUES ('Quantos mundiais tem o palmeiras?', 'Nenhum', '1951 kkk', 'Sub-20, Conta?', 1)");
